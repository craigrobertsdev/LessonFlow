...
namespace LessonFlow.Database.Migrations
{
    ...
    [Migration("20251110173219_RemoveDeleteBehaviousFromAccountSetupStateToWeekPlannerTemplate")]
    partial class RemoveDeleteBehaviousFromAccountSetupStateToWeekPlannerTemplate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LessonFlow.Domain.YearPlans.DayPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("LessonFlow.Domain.YearPlans.WeekPlanner", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("Id");
                    ...
                    b.HasIndex("YearPlanId", "WeekStart")
                        .IsUnique();
            ...
            modelBuilder.Entity("LessonFlow.Components.AccountSetup.State.AccountSetupState", b =>
                {
                    ...
                    b.HasOne("LessonFlow.Domain.PlannerTemplates.WeekPlannerTemplate", "WeekPlannerTemplate")
                        .WithOne()
                        .HasForeignKey("LessonFlow.Components.AccountSetup.State.AccountSetupState", "WeekPlannerTemplateId")
            ...
            modelBuilder.Entity("LessonFlow.Domain.Students.Student", b =>
                {
                    ...
                    b.HasOne("LessonFlow.Domain.YearPlans.YearPlan", null)
                        .WithMany("Students")
            ...
            modelBuilder.Entity("LessonFlow.Domain.YearPlans.DayPlan", b =>
                {
                    b.HasOne("LessonFlow.Domain.YearPlans.WeekPlanner", null)
                        .WithMany("DayPlans")
            ...
            modelBuilder.Entity("LessonFlow.Domain.YearPlans.YearPlan", b =>
                {
                    ...
                    b.HasOne("LessonFlow.Domain.PlannerTemplates.WeekPlannerTemplate", "WeekPlannerTemplate")
                        .WithOne()
                        .HasForeignKey("LessonFlow.Domain.YearPlans.YearPlan", "WeekPlannerTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
