...
namespace LessonFlow.Api.Database.Migrations
{
    ...
    [Migration("20250822211024_AddAccountSetupStateToUser")]
    partial class AddAccountSetupStateToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LessonFlow.Domain.WeekPlanners.DayPlan", b =>
                {
                    ...
                    b.Property<string>("_breakDutyOverrides")
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("LessonFlow.Domain.YearDataRecords.YearData", b =>
                {
                    ...
                    b.Property<string>("_workingDays")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("WorkingDays");
            ...
            modelBuilder.Entity("LessonFlow.Components.AccountSetup.State.AccountSetupState", b =>
                {
                    ...
                    b.OwnsMany("LessonFlow.Components.AccountSetup.State.DayColumn", "ScheduleGrid", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("AccountSetupScheduleGrid", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("UserId");

                            b1.OwnsMany("LessonFlow.Components.AccountSetup.State.ScheduleSlot", "ScheduleSlots", b2 =>
                                {
                                    b2.Property<Guid>("DayColumnId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("DayColumnId", "Id");

                                    b2.HasIndex("SubjectId");

                                    b2.ToTable("AccountSetupScheduleGrid_ScheduleSlots");

                                    b2.WithOwner()
                                        .HasForeignKey("DayColumnId");

                                    b2.HasOne("LessonFlow.Domain.Curriculum.Subject", "Subject")
                                        .WithMany()
                                        .HasForeignKey("SubjectId");

                                    b2.Navigation("Subject");
                                });

                            b1.Navigation("ScheduleSlots");
                        });

                    b.OwnsOne("LessonFlow.Components.AccountSetup.State.ScheduleConfig", "ScheduleConfig", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("AccountSetupScheduleConfig", (string)null);
                            ...
                            b1.OwnsMany("LessonFlow.Components.AccountSetup.State.ScheduleSlot", "ScheduleSlots", b2 =>
                                {
                                    b2.Property<Guid>("ScheduleConfigUserId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("ScheduleConfigUserId", "Id");

                                    b2.HasIndex("SubjectId");

                                    b2.ToTable("AccountSetupScheduleConfig_ScheduleSlots");

                                    b2.WithOwner()
                                        .HasForeignKey("ScheduleConfigUserId");
                    ...
                    b.OwnsMany("LessonFlow.Domain.PlannerTemplates.DayStructure", "DayTemplates", b1 =>
                        {
                            ...
                            b1.ToTable("DayTemplates", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("WeekPlannerTemplateId");
                        });

                    b.OwnsMany("LessonFlow.Domain.ValueObjects.WeekPlannerTemplatePeriod", "Periods", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");
