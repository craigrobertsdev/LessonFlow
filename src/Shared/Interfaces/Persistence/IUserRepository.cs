...
public interface IUserRepository
{
    ...
    Task CompleteAccountSetup(Guid userId, YearPlan yearPlan);
    ...
    Task<YearPlan?> GetYearPlanByYear(Guid userId, int calendarYear, CancellationToken cancellationToken);
